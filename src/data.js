...
let handleTheCrate = {
  ...
  description:
    "Handle the crate is a puzzle which revisits the classic rules of sokoban:" +
...
let fallenStar = {
  ...
  description:
    "A narrative cards game taking place in a Lovecraft world." +
...
let litius = {
  ...
  pseudonyme: "Gehaimme",
  description:
    "LEntrez dans le XIXème siècle d'un univers victorien où magie et révolution industrielle se côtoient à merveille." +
...
let arcania1 = {
  ...
  pseudonyme: "Gehaimme",
  description:
    "Arcania est un monde brisé où les continents dérivent dans un ciel infini." +
...
let japan = {
  ...
  description:
    "Un voyage à l'autre bout du monde... La découverte d'une autre culture. Une expérience inoubliable au pays des ramens et des volcans.",
  producturl:
